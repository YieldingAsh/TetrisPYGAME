...
class Text:
    ...
    def draw(self):
        ...
        self.font.render_to(self.app.screen, (WIN_W * 0.65, WIN_H * 0.22), text='Next', fgcolor='white', size=TILE_SIZE * 1.4, bgcolor='black')
        self.font.render_to(self.app.screen, (WIN_W * 0.64, WIN_H * 0.67), text='Score', fgcolor='white', size=TILE_SIZE * 1.4, bgcolor='black')
        self.font.render_to(self.app.screen, (WIN_W * 0.64, WIN_H * 0.8), text=f'{self.app.tetris.score}', fgcolor='white', size=TILE_SIZE * 1.8, bgcolor='black')
